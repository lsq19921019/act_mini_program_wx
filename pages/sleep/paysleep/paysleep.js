...
Page({
  ...
  switchSel: function(e){
    this.setData({
      coin_type:e.currentTarget.dataset.type
    });
    this.setData({
      selCoin: e.currentTarget.dataset.coin
    });
  ...
  checkSleep: function(){
    ...
    // https://pddmini.hzduomi.net/minipro/user/coinDetails
    var that = this;
    var pams = {
      token: wx.getStorageSync('token'),
    }
